...
const safeFallback = "8f8dfb3cf487bd21a808d49cf9044edac5b701dd";
...
assert.equal(release.build, "11.23");
assert.match(bookmarklet, new RegExp(`@${release.commit}/ANALISE/V11/loader-v11\\.js\\?v=11\\.23\\.0`));
...
(async () => {
  ...
  assert.ok(viaApi.loaded.every((url) => url.includes("v=11.23.0-")));
