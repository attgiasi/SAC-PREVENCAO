...
const safeFallback = "52c236e8fd07fae9da8f24b881706eae34cf773f";
...
assert.equal(release.build, "11.22");
assert.match(bookmarklet, new RegExp(`@${release.commit}/ANALISE/V11/loader-v11\\.js\\?v=11\\.22\\.0`));
...
(async () => {
  ...
  assert.ok(viaApi.loaded.every((url) => url.includes("v=11.22.0-")));
