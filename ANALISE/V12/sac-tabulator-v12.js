(function SACTabulatorV12Factory() {
  "use strict";

  if (window.SACTabulatorV12) return;
  ...
  const OPTION_ALIASES = new Map([
    ["CARTOES APROVADAS", ["CARTOES APROVADOS", "CARTAO APROVADO", "APROVADAS", "APROVADA", "APPROVE", "AUTHORIZED", "AUTORIZADA"]],
    ["CARTOES RECUSADAS", ["CARTOES REPROVADAS", "CARTOES RECUSADOS", "CARTOES REPROVADOS", "CARTAO RECUSADO", "RECUSADA", "REPROVADA", "DECLINE", "DECLINADA", "DENIED", "NEGADA"]],
    ["CARTOES REPROVADAS", ["CARTOES RECUSADAS", "CARTOES RECUSADOS", "CARTOES REPROVADOS", "CARTAO RECUSADO", "RECUSADA", "REPROVADA", "DECLINE", "DECLINADA", "DENIED", "NEGADA"]],
  ...
  function optionTargets(wanted) {
    ...
    return Array.from(new Set([target, ...(OPTION_ALIASES.get(target) || [])].filter(Boolean)));
  }
