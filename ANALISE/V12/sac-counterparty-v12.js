(function SACCounterpartyV12Factory() {
  "use strict";

  if (window.SACCounterpartyV12) return;

  const ENGINE_VERSION = "1.4.0";
  const CACHE_KEY = "sac_prevencao_V12:counterparty_registry";
  const CONFIG_KEY = "sac_prevencao_V12:counterparty_config";
  const LOCAL_RECORDS_KEY = "sac_prevencao_V12:counterparty_local_records";
  const DEFAULT_ENDPOINT = "https://cdn.jsdelivr.net/gh/attgiasi/SAC-PREVENCAO@main/ANALISE/V12/counterparty-registry-v12.json";
  ...
  window.SACCounterpartyV12 = Object.freeze({
