...
const safeFallback = "e3a6592d340eca575a9dadf919ea8bc76a8b68e1";
...
assert.equal(release.build, "11.31");
assert.match(bookmarklet, new RegExp(`@${release.commit}/ANALISE/V11/loader-v11\\.js\\?v=11\\.31\\.0`));
...
(async () => {
  ...
  assert.ok(viaApi.loaded.every((url) => url.includes("v=11.31.0-")));
