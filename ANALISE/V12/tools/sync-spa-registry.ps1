param(
  [string]$RegistryPath = (Join-Path (Split-Path $PSScriptRoot -Parent) "counterparty-registry-v12.json")
)
...
$temporary = Join-Path ([System.IO.Path]::GetTempPath()) "sac-spa-registry-v12"
