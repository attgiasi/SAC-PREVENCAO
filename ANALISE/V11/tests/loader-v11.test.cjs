...
const safeFallback = "fdbfb269c39b5228bb2b59b0b03128f8bc1b2e63";
...
assert.equal(release.build, "11.27");
assert.match(bookmarklet, new RegExp(`@${release.commit}/ANALISE/V11/loader-v11\\.js\\?v=11\\.27\\.0`));
...
(async () => {
  ...
  assert.ok(viaApi.loaded.every((url) => url.includes("v=11.27.0-")));
