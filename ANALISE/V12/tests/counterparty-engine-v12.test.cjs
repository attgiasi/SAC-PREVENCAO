...
const source = fs.readFileSync(path.join(__dirname, "..", "sac-counterparty-v12.js"), "utf8");
vm.runInNewContext(source, context, { filename: "sac-counterparty-v12.js" });

const engine = context.window.SACCounterpartyV12;
...
const operationalRegistry = JSON.parse(fs.readFileSync(path.join(__dirname, "..", "counterparty-registry-v12.json"), "utf8"));
...
console.log("OK - motor de contrapartes V12 validado");
