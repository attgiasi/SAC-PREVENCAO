...
const safeFallback = "1672700de4276d63e9648b67fb70a9ff605379eb";
...
assert.equal(release.build, "11.24");
assert.match(bookmarklet, new RegExp(`@${release.commit}/ANALISE/V11/loader-v11\\.js\\?v=11\\.24\\.0`));
...
(async () => {
  ...
  assert.ok(viaApi.loaded.every((url) => url.includes("v=11.24.0-")));
