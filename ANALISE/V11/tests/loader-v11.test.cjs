...
const safeFallback = "0261bc73392c95a93699880404991c015e808390";
...
assert.equal(release.build, "11.32");
assert.match(bookmarklet, new RegExp(`@${release.commit}/ANALISE/V11/loader-v11\\.js\\?v=11\\.32\\.0`));
...
(async () => {
  ...
  assert.ok(viaApi.loaded.every((url) => url.includes("v=11.32.0-")));
