(function SACMemoryV10Factory() {
  "use strict";

  if (window.SACMemoryV10) return;
  ...
  const LIST_TOMBSTONES_KEY = "sac_prevencao_V10:list_tombstones";
  const SETTINGS_KEY = "sac_prevencao_V10:settings";
  const TRANSPORT_KEY = "sac_prevencao_V10:transport";
  const WINDOW_NAME_KEY = "__SAC_PREVENCAO_V10_MEMORY__=";
