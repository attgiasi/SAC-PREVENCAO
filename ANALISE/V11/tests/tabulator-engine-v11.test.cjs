...
vm.runInContext(fs.readFileSync(path.join(__dirname, "..", "sac-tabulator-v11.js"), "utf8"), context, { filename: "sac-tabulator-v11.js" });

const engine = context.window.SACTabulatorV11;
