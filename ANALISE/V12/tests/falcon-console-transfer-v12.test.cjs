...
(async () => {
  ...
  const packageContext = { Date, BUILD_FAMILY: "12", BUILD_VERSION: "12.4", PACKAGE_SCHEMA: 1, PACKAGE_TTL_MS: 12 * 60 * 60 * 1000 };
  ...
  assert.equal(packageContext.isCurrentPackage({ ...currentFalcon, buildVersion: "12.4" }, "SAC_FALCON"), true, "subversões V12 compatíveis não podem perder o caso durante a troca de página");
