...
vm.runInContext(fs.readFileSync(path.join(__dirname, "..", "sac-ddd-v12.js"), "utf8"), context);

const engine = context.window.SACDddV12;
...
console.log("OK - motor de DDD V12 validado");
